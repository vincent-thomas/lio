...
This is where the book stops saying "here is what a user does" and starts saying "here is why the crate is built that way."

**Note on structure:** This section comes before "What lio Lets You Control" on purpose. Once you understand the core design principles explained here, the full control surface will make more sense. You'll see not just what operations exist, but why they have the shape they do.
...
The central sentence for this whole section is:

an operation is a typed description of work, and `Lio` is the thing that drives it.

Everything in the next chapters is really an expansion of that sentence.

The progression is deliberate:

- first, what it means to drive an operation
- then, how ownership is represented
- then, how completions are delivered
- finally, how the lower-level state-machine abstraction works underneath
...
That is why this section comes before the chapter that zooms back out to "what `lio` lets you control." The broad map makes more sense once the core model is already in place.
...
That combination is the reason the crate can stay close to the operating system without forcing user code to process untyped completion packets everywhere.
