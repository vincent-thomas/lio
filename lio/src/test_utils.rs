...
use crate::api::{io::Io, ops, socket};
...
#[doc(hidden)]
pub fn unix_stream_socket() -> Io<'static, ops::Socket> {
...
/// Returns the Resource which must be closed by the caller using `lio::close()`.
#[doc(hidden)]
pub fn unix_dgram_socket() -> Io<'static, ops::Socket> {
...
#[doc(hidden)]
pub fn tcp_socket() -> Io<'static, ops::Socket> {
...
/// Returns a Io that can be used with `.send()`, `.when_done()`, `.blocking()`, etc.
#[doc(hidden)]
pub fn tcp6_socket() -> Io<'static, ops::Socket> {
...
/// Returns a Io that can be used with `.send()`, `.when_done()`, `.blocking()`, etc.
#[doc(hidden)]
pub fn udp_socket() -> Io<'static, ops::Socket> {
...
/// Returns a Io that can be used with `.send()`, `.when_done()`, `.blocking()`, etc.
#[doc(hidden)]
pub fn udp6_socket() -> Io<'static, ops::Socket> {
